(function() {
    ...
    */
    ...
    console.log (text.replace(/Manuel Marques de Sousa/, 'Thiago Antonio Xavier Silva'));
    ...
    */
    ...
    console.log (text.replace(/\w/g, function (string) {
    ...
    */
    ...
    console.log( text.replace( regexDate, replaceDate ) ); // Por quê replaceDate e não replaceDate()?
})();